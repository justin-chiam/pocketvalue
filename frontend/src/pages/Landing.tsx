    ...
    <div className="landing">
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <p className="hero-sub">
            ...
            finds its smartest next chapter: repair, resell, trade in, donate,
            or recycle.
          </p>
        ...
        <aside className="ticket" aria-label="Example device report">
          ...
          <div className="ticket-verdict">
            ...
            <p>
              Best route: <strong>repair</strong>. A $49 battery buys two more
              good years. New phone not required.
            </p>
          </div>
        </aside>
      </section>
      ...
      <section className="problem" data-reveal>
        <div className="container">
          <h2>
            Working tech gets binned because deciding what to do with it is a
            chore.
          </h2>
          ...
          <div className="stats">
            ...
            <div className="stat">
              ...
              <span className="stat-label">
                of it formally collected and recycled
              </span>
            </div>
            <div className="stat">
              <span className="stat-figure">1 hr</span>
              <span className="stat-label">
                of research per device. That's the real barrier we remove.
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="story-intro" id="how">
        <h2 data-reveal>One photo does the homework.</h2>
      </section>
      ...
      <section className="outcomes">
        <div className="container">
          <h2 data-reveal>Five good endings, in order.</h2>
          ...
          <div className="last-resort" data-reveal>
            <span className="last-resort-title">Buy new</span>
            <p>
              The last resort, not the default. When it's genuinely time, we'll
              say so. Until then, we'll talk you out of it.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="footer">
        <span className="wordmark">PocketValue</span>
        <p>Built at the 2026 CSESoc Flagship Hackathon, to keep good tech in use.</p>
      </footer>
    </div>
  )
}
